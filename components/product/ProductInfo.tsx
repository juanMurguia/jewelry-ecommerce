  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="mt-3">
        ...
        <a
          href="#reviews"
          className="ml-3 text-sm font-medium text-indigo-300 hover:text-indigo-200"
        >
      ...
      <button
        onClick={handleClick}
        className="mt-8 w-full cursor-pointer bg-amber-200 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-gray-900 hover:bg-amber-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-300"
        disabled={!orderResData} // Deshabilita el botón hasta que haya datos
      >
